    ...
    return (
        <form className="px-6 flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
            <div>
                ...
                <Input id="description" {...register("duration", { valueAsNumber: true, })} type='number' className="mt-1" />
                ...
                <Controller name="isPrivate" control={control}
                    render={({ field }) => (<Select value={field.value ? "true" : "false"} onValueChange={(value) => field.onChange(value === 'true')}>
